...
btncorbaseazul.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#538c82");
  document.querySelectorAll(".corbasecostas").forEach(v => v.style.fill = "#538c82");
  document.getElementById('CB').style.backgroundColor = "#538c82";
});    
//base vermelha
